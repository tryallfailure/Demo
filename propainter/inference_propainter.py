...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--save_fps', type=int, default=30, help='Frame per second. Default: 30')
    parser.add_argument(
    ...
    rel_path = os.path.join(*args.video.rstrip(os.sep).split(os.sep)[-2:])
    save_root = os.path.join(args.output, rel_path)
